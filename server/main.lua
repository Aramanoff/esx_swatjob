...
ESX.RegisterServerCallback('esx_swatjob:getVehicleFromPlate', function(source, cb, plate)
	MySQL.Async.fetchAll(
...
ESX.RegisterServerCallback('esx_swatjob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'swat' then
			Citizen.Wait(5000)
			TriggerClientEvent('esx_swatjob:updateBlip', -1)
		end
	end	
end)

RegisterServerEvent('esx_swatjob:spawned')
AddEventHandler('esx_swatjob:spawned', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_swatjob:forceBlip')
AddEventHandler('esx_swatjob:forceBlip', function()
	TriggerClientEvent('esx_swatjob:updateBlip', -1)
end)
...
RegisterServerEvent('esx_swatjob:message')
AddEventHandler('esx_swatjob:message', function(target, msg)
